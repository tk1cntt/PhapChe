...
export default function CreateRequestPage() {
  ...
  // Demo user data
  const userName = 'Mai Phuong';
  const userRole = 'Customer';
  const workspaceName = 'Cong ty An Phat';
        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            ...
            <p className="text-[15px] text-slate-500 font-medium">
              Tra loi vai cau hoi de chuyen vien co du thong tin tiep nhan ho so va xu ly dung SLA.
            </p>
          </div>
            ...
            <div className="bg-white border border-slate-200 rounded-2xl shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="mt-6 pt-6 border-t border-slate-200">
                  <h3 className="text-lg font-bold text-slate-900 mb-4">Thong tin so bo</h3>
                  <RequestForm />
                </div>
              </div>
            </div>
