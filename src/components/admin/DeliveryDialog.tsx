...
export function DeliveryDialog({ request, onClose, onSuccess }: DeliveryDialogProps) {
  ...
  const nextStatus = request.status === 'approved' ? 'delivered' : 'closed';
  const confirmLabel = request.status === 'approved' ? t('btnDeliver') : t('btnClose');
      ...
      <div className="dialog-container" onClick={e => e.stopPropagation()}>
        ...
        <div className="dialog-summary">
          ...
          {request.reviewerName && (
            <div className="summary-row">
              <span className="summary-label">{t('colReviewer')}</span>
              <span className="summary-value">{request.reviewerName}</span>
            </div>
          )}
          <div className="summary-row">
        ...
        <div className="dialog-note">
          ...
          <span>
            {request.status === 'approved' ? t('noteDeliver') : t('noteClose')}
          </span>
        </div>
