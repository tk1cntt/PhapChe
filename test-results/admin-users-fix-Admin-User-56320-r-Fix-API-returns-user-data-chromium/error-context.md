...
- Name: admin-users-fix.spec.ts >> Admin Users Page - After ReactQueryProvider Fix >> API returns user data
- Location: e2e\admin-users-fix.spec.ts:77:7
...
- generic [active] [ref=e1]:
  - button "🇻🇳 Tiếng Việt" [ref=e3] [cursor=pointer]:
    - generic [ref=e4]: 🇻🇳
    - generic [ref=e5]: Tiếng Việt
  - generic [ref=e9]:
    - heading "GitNexus Legal" [level=3] [ref=e10]
    - generic [ref=e11]:
      - generic [ref=e17]:
        - img "mail" [ref=e19]:
          - img [ref=e20]
        - textbox "Email" [ref=e22]: customer.demo@example.test
      - generic [ref=e28]:
        - img "lock" [ref=e30]:
          - img [ref=e31]
