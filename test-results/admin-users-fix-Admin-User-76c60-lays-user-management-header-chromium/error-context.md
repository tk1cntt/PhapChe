...
- Name: admin-users-fix.spec.ts >> Admin Users Page - After ReactQueryProvider Fix >> displays user management header
- Location: e2e\admin-users-fix.spec.ts:35:7
...
Locator: locator('h1')
Expected pattern: /User Management|Quản lý người dùng/i
Timeout: 5000ms
