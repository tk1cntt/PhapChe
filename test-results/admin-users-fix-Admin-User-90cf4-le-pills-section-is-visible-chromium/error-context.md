...
- Name: admin-users-fix.spec.ts >> Admin Users Page - After ReactQueryProvider Fix >> role pills section is visible
- Location: e2e\admin-users-fix.spec.ts:49:7
...
Locator: locator('text=/Role|Rôles|Người dùng/i').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Role|Rôles|Người dùng/i').first()
