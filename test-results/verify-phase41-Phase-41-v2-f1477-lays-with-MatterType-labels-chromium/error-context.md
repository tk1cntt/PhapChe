...
- Name: verify-phase41.spec.ts >> Phase 41: v2 Create Request Wizard >> Step 1: Service selection displays with MatterType labels
- Location: e2e\verify-phase41.spec.ts:19:7
